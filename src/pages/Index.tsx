        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">AWS Auto Scaling Group</h1>
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="p-4 text-center shadow-aws">
            <div className="text-2xl font-bold text-secondary">{instances.length}</div>
            <div className="text-sm text-muted-foreground">Running Instances</div>
          </Card>
          <Card className="p-4 text-center shadow-aws">
            <div className="text-2xl font-bold text-success">{loadBalancer.healthyTargets}</div>
            <div className="text-sm text-muted-foreground">Healthy Targets</div>
          </Card>
          <Card className="p-4 text-center shadow-aws">
            <div className="text-2xl font-bold text-primary">{scalingPolicy.averageCpuUtilization}%</div>
            <div className="text-sm text-muted-foreground">Average CPU</div>
          </Card>
          <Card className="p-4 text-center shadow-aws">
            <div className="text-2xl font-bold text-warning">{loadBalancer.requestsPerMinute}</div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-foreground">EC2 Instances</h2>
              <Badge variant="secondary">
                Min: {scalingPolicy.minInstances} | Max: {scalingPolicy.maxInstances}
              </Badge>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {Array.from({ length: scalingPolicy.maxInstances - instances.length }).map((_, index) => (
                <Card key={`placeholder-${index}`} className="p-4 border-2 border-dashed border-muted opacity-50">
        ...
        <Card className="mt-8 p-6 bg-gradient-to-r from-muted/30 to-accent/10">
          <h3 className="text-lg font-bold text-foreground mb-3">HTTP Server Configuration</h3>
          <div className="bg-card p-4 rounded-lg border border-border">
            <div className="text-sm text-muted-foreground mb-2">User Data Script:</div>
